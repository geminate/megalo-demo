<template>
    <div class="basic-page">
        <div class="item-div">
            <p class="p">Your firstname is: {{firstName}}</p>
            <p>Your lastname is: {{lastName}}</p>
            <p>So your name is: {{name}}</p>
        </div>
        <div class="item-div">
            <input class="input-test" v-model="inputValue"/>
            {{inputValue}}
        </div>
        <div class="item-div">
            <!-- 网咯地址 -->
            ...
            <!-- 本地地址 -->
            <img class="img" src="/static/img/bd_logo1.png">

            <!-- css 背景 -->
            <div class="background-test img"></div>
        </div>
    </div>
</template>
